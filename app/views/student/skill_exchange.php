<div class="container" style="padding-bottom: 4rem;">
    ...
    <div
        ...
        <div>
            ...
            <p style="color: var(--text-muted);">Kelola catatan belajar Anda berdasarkan jurusan. Maksimal 5 catatan per
                jurusan.</p>
        </div>
...
<div style="display: flex; gap: 1rem; margin-bottom: 2rem; flex-wrap: wrap; align-items: center;">
    <div style="flex: 1; min-width: 250px;">
        <select id="majorSelect"
            style="width: 100%; padding: 0.75rem 1rem; border-radius: 0.5rem; background: rgba(0,0,0,0.1); border: 1px solid var(--border-color, rgba(255,255,255,0.1)); color: inherit; font-family: inherit; font-size: 1rem; outline: none; cursor: pointer;">
    ...
    <button id="addNoteBtn" class="btn-primary"
        style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; border: none; border-radius: 0.5rem; cursor: pointer; transition: all 0.2s;">
...
<div id="notesStatus" style="margin-bottom: 1.5rem; font-size: 0.95rem; color: var(--text-muted);">
    Menampilkan catatan untuk jurusan <strong id="currentMajorLabel" style="color: inherit;">Web Development</strong>
    (<span id="noteCount">0</span>/5)
</div>
...
<div id="noteModal"
    ...
    <div class="glass-card" style="width: 100%; max-width: 500px; margin: 0; position: relative;">
        <button onclick="closeModal()"
            style="position: absolute; top: 1rem; right: 1rem; background: none; border: none; color: var(--text-muted); font-size: 1.5rem; cursor: pointer; transition: color 0.2s;"
            onmouseover="this.style.color='inherit'" onmouseout="this.style.color='var(--text-muted)'">
            <i class="fa-solid fa-xmark"></i>
        </button>
        ...
        <div style="margin-bottom: 1rem;">
            <label style="display: block; margin-bottom: 0.5rem; color: var(--text-muted); font-size: 0.9rem;">Judul
                Catatan</label>
            <input type="text" id="noteTitle" placeholder="Misal: Rangkuman Jaringan Dasar"
                style="width: 100%; padding: 0.75rem; border-radius: 0.5rem; background: rgba(0,0,0,0.1); border: 1px solid rgba(255,255,255,0.1); color: inherit; font-family: inherit; outline: none; transition: border-color 0.2s;"
                onfocus="this.style.borderColor='rgba(255,255,255,0.3)'"
                onblur="this.style.borderColor='rgba(255,255,255,0.1)'" required>
        </div>
        <div style="margin-bottom: 1.5rem;">
            <label style="display: block; margin-bottom: 0.5rem; color: var(--text-muted); font-size: 0.9rem;">Isi
                Catatan</label>
            <textarea id="noteContent" rows="6" placeholder="Tulis detail catatan Anda di sini..."
                style="width: 100%; padding: 0.75rem; border-radius: 0.5rem; background: rgba(0,0,0,0.1); border: 1px solid rgba(255,255,255,0.1); color: inherit; font-family: inherit; resize: vertical; outline: none; transition: border-color 0.2s;"
                onfocus="this.style.borderColor='rgba(255,255,255,0.3)'"
                onblur="this.style.borderColor='rgba(255,255,255,0.1)'" required></textarea>
        </div>

        <button onclick="saveNote()" class="btn-primary"
            style="width: 100%; padding: 0.75rem; border: none; border-radius: 0.5rem; font-size: 1rem; cursor: pointer;">
